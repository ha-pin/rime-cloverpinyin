...
def main(args):
    #text_dict, text_phrase = generate('clover_hapin')
    #open('clover_hapin.base.dict.yaml', 'w', encoding = 'UTF-8').write(text_dict)
    #open('clover_hapin.phrase.dict.yaml', 'w', encoding = 'UTF-8').write(text_phrase)
    ...
    word_dict_name = 'clover_hapin.base'
    parse_dict_name = 'clover_hapin.phrase'
